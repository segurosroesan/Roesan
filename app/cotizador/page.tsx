                    ...
                    <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-start">
                        ...
                        <div className="lg:col-span-7 xl:col-span-6 space-y-6">
                            ...
                            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-5xl mb-6 shadow-sm leading-tight text-balance">
                                Cotiza Todos Tus Seguros en un Solo Lugar
                            </h1>

                            <p className="text-lg lg:text-xl text-white/90 leading-relaxed max-w-xl">
                                Selecciona el tipo de seguro que necesitas y completa tus datos. Analizamos tu información y volvemos con las mejores tarifas del mercado respaldadas por aseguradoras líderes como Sura, Allianz, y Mapfre.
                            </p>

                            <div className="pt-4 space-y-3">
                                {[
                                    "Ahorra hasta un 30% comparando pólizas",
                                    "Asesoría personalizada sin costos ocultos",
                                    "Te acompañamos durante toda la vigencia",
                                ].map((feature, i) => (
