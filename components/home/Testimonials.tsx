...
const testimonials = [
    {
        quote: "Pagaba $2.8M al año por responsabilidad civil con otra agencia que no visitaba mi fábrica. Roesan vino, analizó el riesgo real de Engativá, estructuró cobertura con Sura y Allianz, y bajé a $1.8M manteniendo la cobertura. Ese ahorro de $1M anuales y el servicio de verdad justifica estar con Roesan.",
    ...
    {
        quote: "Cuando quedé embarazada me asusté pensando que no podría cambiar mi seguro de vida. Roesan no solo me lo permitió, sino que me estructuró una póliza flexible de $70M de cobertura que crecía con mi familia. Ahora duermo tranquila sabiendo que mis hijos estarían protegidos.",
    ...
    {
        quote: "Somos constructores y las pólizas de cumplimiento son complejas. Otra agencia me pidió $15M por lo que ofrecía. Roesan estructuró con 3 aseguradoras y me dio mejor cobertura por $8.5M, además con términos más flexibles. En 8 proyectos, 0 problemas. Eso es asesoría de verdad.",
    ...
    {
        quote: "Tengo 32 camiones y en 5 años hice 3 reclamaciones. Con la póliza que Roesan estructuró con Sura, los pagos llegaron en menos de 15 días. Con otra agencia antes, la misma aseguradora tardaba 45 días. Roesan estructuró bien el trámite y eso me ahorró cash flow.",
